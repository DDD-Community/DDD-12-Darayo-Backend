...
public interface PerformanceRepository extends JpaRepository<Performance, Long> {
    @Query("SELECT DISTINCT " +
            ...
            "t.id as timetableId, t.performanceDate as performanceDate, t.startTime as timetableStartTime, t.endTime as timetableEndTime, t.performanceHall as timetablePerformanceHall, " +
            "ta.id as timetableArtistId, ta.artist.id as timetableArtistArtistId, ta.artist.artist.displayName as timetableArtistName, ta.participationType as timetableArtistType, " +
            ...
            "pa.id as performanceArtistId, pa.artist.displayName as performanceArtistDisplayName " +
            "FROM Performance p " +
